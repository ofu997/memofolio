                ...
                >
                  <section id="icons-and-comment-form">
                    ...
                    <div className='flex' style={{ alignItems: 'center' }}>
                      ...
                      <a href={`/memo/${image?.id}`}  className="link-that-does-not-look-like-a-link action-links">
                        View standalone
                      </a>
                      )}
                      {userIsValidAndOwnsImage && (
                      <a href={`/memo/${image.id}/edit`} title="Edit image" className="link-that-does-not-look-like-a-link">
